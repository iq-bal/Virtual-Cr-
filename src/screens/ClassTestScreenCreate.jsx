...
const ClassTestCreateScreen = ({navigation, route}) => {
  ...
  async function createClassTest(roll) {
    const apiUrl = `https://tiny-teal-hedgehog-wig.cyclic.app/classtest/${roll}`;
    try {
      ...
      if (response.ok) {
        console.log('ClassTest created successfully:', responseData.message);
      ...
      console.error('Error creating ClassTest:', error.message);
    }
  }
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView vertical={true} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          onPress={async () => await createClassTest(roll)}>
...
export default ClassTestCreateScreen;
