...
const LabQuizCreateScreen = ({navigation, route}) => {
  ...
  async function createLabQuiz(roll) {
    const apiUrl = `https://tiny-teal-hedgehog-wig.cyclic.app/labquiz/${roll}`;
    try {
      ...
      if (response.ok) {
        console.log('labquiz created successfully:', responseData.message);
      ...
      console.error('Error creating labquiz:', error.message);
    }
  }
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView vertical={true} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          onPress={async () => await createLabQuiz(roll)}>
...
export default LabQuizCreateScreen;
